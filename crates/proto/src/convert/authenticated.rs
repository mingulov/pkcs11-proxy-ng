...
// Wire `Debug` redaction for `AuthenticatedMechanismOutput`,
// `authenticated_mechanism_output::Output`, and `AuthenticatedParameters` is
// generated by build.rs (`redacted_debug_gen.rs`, from secret-fields.toml).
