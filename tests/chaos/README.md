...
## Differences from the resilience fixture

The resilience fixture (tests/r2_resilience/) injects faults on the
NETWORK between shim and daemon via toxiproxy. This fixture injects
faults at the BACKEND boundary inside the daemon. The two are
complementary: together they cover the full failure surface.
