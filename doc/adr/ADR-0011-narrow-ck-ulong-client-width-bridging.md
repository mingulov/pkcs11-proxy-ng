...
- **D3 — Targets (2026-09-13 supersedes 2026-07-02 native-host scope).** Client targets:
  ...
  **Windows x64 native-provider daemon support is withdrawn/deferred for v0.2**;
  ...
  [2026-09-19 T2run: the 32-bit Windows client exclusion lifts — first
  green win32 run (i686 build, WOW64 suites, stub live-load per
  ADR-0014). The remaining client exclusions (`pc-windows-gnu`,
  big-/mixed-endian) and native-host exclusions stand.]
